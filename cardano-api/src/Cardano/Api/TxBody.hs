...
--TODO: WTF is this? We already have serialiseAddress!
...
-- | Identify the location of a 'Witness' (and typically a 'ScriptWitness')
-- within the context of a 'TxBody'. These are indexes of the objects within
-- the transaction that need witnesses: inputs, minted assets, withdrawals
-- and certificates. These are simple numeric indices, enumerated from zero.
